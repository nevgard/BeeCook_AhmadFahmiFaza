...
<svelte:head>
	<title>Edit Resep - BeeCook</title>
</svelte:head>

<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
	<h1 class="text-3xl font-bold text-navy-900 mb-8">Edit Resep</h1>

	<!-- (The form structure is identical to Create, reused the HTML markup) -->
